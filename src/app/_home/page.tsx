...
export default function HomePage() {
  ...
  const skills = [
    ...
    { name: "AWS S3", icon: IMAGES.s3 },
    { name: "Docker", icon: IMAGES.docker },
    { name: "Sequelize", icon: IMAGES.sequelize },
  ...
  const projects = [
    {
      ...
      description:
        "A comprehensive MERN stack application with role-based access control featuring Super Admin, Admin, and Employee portals. Integrated AWS S3 for secure document storage and Sequelize for robust database management.",
      technologies: [
        "React",
        "Node.js",
        "MongoDB",
    ...
    },
    {
      ...
      description:
        "Scalable e-commerce solution with separate portals for administrators, sellers, and customers. Features comprehensive product management, order processing, and seamless user interactions.",
    ...
    },
    {
      ...
      description:
        "Responsive healthcare platform featuring comprehensive pharmacy management and doctor-patient interaction systems, significantly improving healthcare accessibility and quality of care.",
      technologies: [
        "React",
        "Node.js",
        "MongoDB",
    ...
    },
    {
      ...
      description:
        "Professional website and admin panel designed for DHA-Islamabad with secure authentication systems and robust data management capabilities for streamlined governmental operations.",
      technologies: [
        "React",
        "Node.js",
        "MySQL",
    ...
    },
    {
      ...
      description:
        "Dynamic marketplace platform with dedicated portals for administrators, restaurants, and customers. Enables efficient menu management, order processing, and customer interaction.",
    ...
    },
    {
      ...
      description:
        "Comprehensive staff management platform designed to enhance productivity and streamline organizational workflows through an intuitive and user-friendly interface.",
  ...
  const expertise = [
    {
      ...
      description:
        "Building scalable microservices using Node.js, React, Docker, and MySQL with proper containerization",
      icon: "🏗️",
      color: "from-blue-50 to-indigo-50",
      iconBg: "bg-blue-100",
    },
    {
      ...
      description:
        "AWS S3 storage optimization, lifecycle policies, SES email services, and EC2 deployment strategies",
      icon: "☁️",
      color: "from-purple-50 to-pink-50",
      iconBg: "bg-purple-100",
    },
    {
      ...
      description:
        "End-to-end MERN stack applications with RESTful APIs, responsive UI, and database optimization",
      icon: "💻",
      color: "from-green-50 to-emerald-50",
      iconBg: "bg-green-100",
    },
  ...
  return (
    <>
      ...
      <section
        id="home"
        className="relative min-h-screen pt-24 pb-10 flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100"
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <div className="mb-8 h-16 flex items-center justify-center">
              <p className="text-xl sm:text-2xl lg:text-3xl text-gray-600 font-light">
                ...
                <span className="font-bold text-indigo-600 inline-block min-w-[340px] sm:text-center">
                  <span key={currentRole} className="animate-fade-in-up">
                    {roles[currentRole]}
                  </span>
                </span>
              </p>
            ...
            {/* Alternative Option 1 - Even More Professional */}
            <p className="text-lg sm:text-xl text-gray-700 max-w-4xl mx-auto mb-12 leading-relaxed">
              ...
              web applications. Currently developing Next.js website with
              Supabase integrations at Webrange Solutions. Gold Medalist CS
              graduate passionate about creating efficient, scalable solutions.
            </p>
            {/* CTA Buttons */}
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto">
              {stats.map((stat, index) => (
                ...
                >
                  <div
                    className={`text-3xl sm:text-4xl font-bold mb-2 group-hover:scale-110 transition-transform duration-300 ${
                      stat.label === "Gold Medalist"
                        ? "text-yellow-600"
                        : "text-indigo-600"
                    }`}
                  >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Strong academic foundation in Computer Science with exceptional
          ...
          <div className="max-w-4xl mx-auto">
            <div
              className={`bg-gradient-to-br ${education.color} rounded-2xl p-8 border border-gray-200 hover:shadow-lg transition-all duration-300 animate-fade-in-up relative overflow-hidden`}
            >
              {/* Achievement Badge */}
              <div className="absolute top-4 right-4">
                <div
                  className={`w-16 h-16 ${education.medalBg} rounded-full flex items-center justify-center border-4 border-yellow-300 animate-pulse`}
                >
              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between pr-20">
                <div className="flex items-center space-x-4 mb-4 md:mb-0">
                  <div
                    className={`w-16 h-16 ${education.iconBg} rounded-full flex items-center justify-center`}
                  >
            ...
            {projects.map((project, index) => (
              ...
              >
                <div className="flex items-start justify-between mb-6">
                  <div
                    className={`w-12 h-12 ${project.iconBg} rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300`}
                  >
      ...
      <section id="experience" className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Building expertise through hands-on experience in modern web
              development, admin panels, and cloud technologies
            </p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Specialized skills developed through real-world projects and
